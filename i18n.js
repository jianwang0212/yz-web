...
const translations = {
    zh: {
        ...
        'projects.socialpulse_desc': '五平台发布状态和最近标题：Instagram、知乎、Reddit、小红书、X 的实时检查面板',
        'projects.back': '← 返回项目',
    ...
    en: {
        ...
        'projects.socialpulse_desc': 'A live five-platform panel for publish status and recent titles across Instagram, Zhihu, Reddit, Xiaohongshu, and X',
