...
const translations = {
    zh: {
        ...
        'essaysIndex.cardVocal.title': '声乐课：把声音变成可调系统',
        'essaysIndex.cardVocal.desc': '从 Kevin vocal class 提炼出来的公开笔记：字型、气流、气压如何变成可感知、可重复的练声变量。',
        ...
        'essayVocal.meta.title': '声乐课：把声音变成可调系统 - Zi Yin',
        'essayVocal.meta.description': '银子 / Zi Yin 关于声乐训练的公开改写版：把发声拆成字型、气流、气压和身体反馈，形成可重复调整的练习系统。',
        'essayVocal.kicker': 'Music Garden · Practice Note',
        'essayVocal.title': '声乐课：把声音变成可调系统',
        'essayVocal.lede': '我原来以为练声是在寻找一个“正确声音”。这节课真正改变我的地方，是把声音拆成字型、气流、气压和身体反馈：每个字、每个音高，都可以被调试。',
        ...
        'essayVocal.map.title': '这不是一份声乐教程，而是一张发声调试地图。',
        'essayVocal.node.center.title': 'Voice',
        'essayVocal.node.center.desc': '可调系统',
        'essayVocal.node.vowels.title': 'Diction',
        'essayVocal.node.vowels.desc': '字型与舌位',
        'essayVocal.node.air.title': 'Air',
        'essayVocal.node.air.desc': '气流与气压',
        'essayVocal.node.high.title': 'High Notes',
        'essayVocal.node.high.desc': '不是硬推',
        'essayVocal.node.tools.title': 'Tools',
        'essayVocal.node.tools.desc': 'NEI / fa / lip trill',
        'essayVocal.node.feedback.title': 'Feedback',
        'essayVocal.node.feedback.desc': '身体传感器',
        ...
        'essayVocal.system.title': '练声不是追求一个标准答案，而是建立可重复的发声条件。',
        'essayVocal.system.p1': '我从这页 Confluence 笔记里提炼出的第一句话是：发声等于咬字加音高。真正的目标不是模仿某个歌手的音色，而是在每一个字、每一个音高上，都能舒服、持续、健康地发出声音。',
        'essayVocal.system.p2': '音色当然重要，但顺序不能反过来。先有轻松稳定的发声，再学习风格化处理，最后才可能形成自己的声音。否则风格很容易变成代偿：用表情、喉咙、音量和蛮力遮盖身体还没有学会的控制。',
        'essayVocal.vowels.title': '我开始把声音拆成三个变量：字型、气流、气压。',
        'essayVocal.vowels.p1': '这套笔记里最有用的模型，是把每个字和音高看成三个变量的结果：字型决定舌位和口腔内部空间，辅音改变气流的开合，气压来自腹部和横膈膜的支持。唱不上去时，问题不一定是“再用力一点”，而是这三个变量没有在那个音高上重新匹配。',
        'essayVocal.vowels.p2': '这个模型让我把抽象感受变成可观察对象。嘴外面不一定需要张得更大，真正变化的是舌头、口腔内部空间和共振位置。外肌越紧，越容易把注意力从可训练的变量上移走。',
        'essayVocal.air.title': '气不是越多越好，力也不是越大越好。',
        'essayVocal.air.p1': '我以前容易把高音理解成“更大力”和“更大声”。但在练习里，高音经常需要更稳定、更细的气流；低音反而可能需要更多气。下行音阶里 lip trill 断掉，暴露的不是音准问题，而是气流没有随着音高变化。',
        'essayVocal.air.p2': '这也是为什么腹部用力本身不够。真正难的是核心参与，同时吐气仍然均匀、轻松、细。气压和气流必须分开感知，否则很容易把“支持”误解成“推”。',
        'essayVocal.high.title': '高音的问题，通常不是从高音开始解决。',
        'essayVocal.high.p1': '高音会把问题放大，但问题常常来自低音区已经建立好的坏习惯：外肌紧张、舌位不稳、喉位上移、胸声或头声比例失衡。只盯着高音练，容易把错误动作练得更熟。',
        'essayVocal.high.p2': '我更愿意把高音当成诊断工具。它告诉我哪里在代偿，然后回到低一点的音区，用更轻、更稳、更舒服的方式重新建立路径。可以先小声唱到，再决定是否要唱大声。',
        'essayVocal.tools.title': 'NEI、fa、lip trill 不是咒语，而是控制变量的工具。',
        'essayVocal.tools.p1': '用 NEI 唱 scale 的意义，是用鼻音和前舌位减少一部分变量，让身体先找到高音里“更薄、更靠前、更省力”的感觉。它不是最终声音，而是一个入口：先在容易成功的字上找到位置，再迁移到其他咬字。',
        'essayVocal.tools.p2': 'fa 或 fo 则像另一种矫正工具：当喉头偏高、声音挤、气流太少时，用更低的舌位和更多气流把身体带回中间。练习不是为了把所有歌都唱成练声字，而是为了知道不同问题应该用什么工具暴露、隔离、修正。',
        'essayVocal.feedback.title': '身体反馈比“听起来对不对”更早发生。',
        'essayVocal.feedback.p1': '这页笔记里反复出现几个传感器：手指放在喉头，感受高音时是否前后上下移动；手指放在唇边，检查面部肌肉有没有紧张；注意舌头和口腔空间，而不是只把注意力放在听觉上。',
        'essayVocal.feedback.p2': '这对我很重要，因为唱歌很容易被结果绑架。只听音准和音量，会忽略身体正在用错误方式完成任务。练声的价值，是在声音听起来还没完全变好之前，先建立更可靠的内部反馈。',
        'essayVocal.song.title': '最后，声乐训练应该回到歌曲，而不是停在练习。',
        'essayVocal.song.p1': '这篇文章对 thisisyz 的意义，不是把私人的声乐课笔记公开成教程，而是把 vocal 放回我的音乐系统里。唱歌不是制作的附属品。它是最直接的声源，也是歌词、旋律、情绪和录音工程之间的交界面。',
        'essayVocal.song.p2': '如果我能更准确地理解自己的声音，我就能更准确地写歌、录音、编配和制作。声乐训练最后不是为了证明我能唱多高，而是为了让一首歌需要的声音，更稳定地出现。',
    ...
    en: {
        ...
        'essaysIndex.cardVocal.stage': 'Practice Note',
        'essaysIndex.cardVocal.title': 'Vocal Class: Turning Voice into a Tunable System',
        'essaysIndex.cardVocal.desc': 'A public note distilled from Kevin vocal class: how diction, airflow, and pressure become repeatable vocal variables.',
        ...
        'essayWhyBerklee.footer.essays': 'Essays',
        'essayVocal.meta.title': 'Vocal Class: Turning Voice into a Tunable System - Zi Yin',
        'essayVocal.meta.description': 'Zi Yin’s public essay on vocal training: breaking voice into diction, airflow, pressure, and body feedback as a repeatable practice system.',
        'essayVocal.kicker': 'Music Garden · Practice Note',
        'essayVocal.title': 'Vocal Class: Turning Voice into a Tunable System',
        'essayVocal.lede': 'I used to think vocal practice meant searching for one “correct voice.” This class changed the problem: voice can be broken into diction, airflow, pressure, and body feedback. Every syllable and every pitch can be debugged.',
        'essayVocal.meta.source': 'Source: Confluence',
        'essayVocal.meta.stage': 'Draft for thisisyz',
        'essayVocal.meta.tended': 'Last tended: May 2026',
        'essayVocal.map.kicker': 'Knowledge Map',
        'essayVocal.map.title': 'This is not a vocal tutorial. It is a map for debugging voice.',
        'essayVocal.node.center.title': 'Voice',
        'essayVocal.node.center.desc': 'Tunable system',
        'essayVocal.node.vowels.title': 'Diction',
        'essayVocal.node.vowels.desc': 'Vowels and tongue position',
        'essayVocal.node.air.title': 'Air',
        'essayVocal.node.air.desc': 'Flow and pressure',
        'essayVocal.node.high.title': 'High Notes',
        'essayVocal.node.high.desc': 'Not pushing harder',
        'essayVocal.node.tools.title': 'Tools',
        'essayVocal.node.tools.desc': 'NEI / fa / lip trill',
        'essayVocal.node.feedback.title': 'Feedback',
        'essayVocal.node.feedback.desc': 'Body sensors',
        'essayVocal.node.song.title': 'Song',
        ...
        'essayVocal.system.title': 'Vocal practice is not about chasing one standard answer. It is about building repeatable conditions for sound.',
        'essayVocal.system.p1': 'The first line I distilled from the Confluence note is simple: voice equals diction plus pitch. The real goal is not to imitate another singer’s tone, but to make every syllable at every pitch feel comfortable, sustainable, and healthy enough to repeat.',
        'essayVocal.system.p2': 'Tone matters, but the order matters more. Stable and relaxed sound comes first, then stylized color, and only then something like a personal vocal identity. Otherwise style can become compensation: facial tension, throat pressure, volume, and force covering for control the body has not learned yet.',
        'essayVocal.vowels.title': 'I started breaking voice into three variables: diction, airflow, and pressure.',
        'essayVocal.vowels.p1': 'The most useful model in the note treats each syllable and pitch as the result of three variables. Diction shapes tongue position and inner mouth space. Consonants change how the air opens or closes. Pressure comes from abdominal and diaphragmatic support. When a note fails, the answer is not necessarily “try harder.” It may be that the three variables have not been rematched for that pitch.',
        'essayVocal.vowels.p2': 'That model turns vague sensation into something observable. The outside of the mouth does not always need to open wider. The real movement may be in the tongue, internal mouth space, and resonance position. The tighter the external muscles get, the easier it is to lose track of the variables that can actually be trained.',
        'essayVocal.air.title': 'More air is not always better, and more force is not always better.',
        'essayVocal.air.p1': 'I used to understand high notes as “more force” and “more volume.” In practice, high notes often need a steadier, thinner stream of air, while low notes may need more air. When lip trills break on a descending scale, the exposed problem is not pitch. It is airflow failing to change with pitch.',
        'essayVocal.air.p2': 'That is why abdominal effort alone is not enough. The hard part is letting the core participate while the exhale remains even, light, and narrow. Pressure and airflow have to be felt separately, or “support” quickly turns into “pushing.”',
        'essayVocal.high.title': 'High-note problems usually should not be solved from high notes first.',
        'essayVocal.high.p1': 'High notes magnify problems, but the problem often begins with habits already built in the lower range: external muscle tension, unstable tongue position, rising larynx, or an imbalanced mix of chest and head voice. Practicing only the high note can make the wrong movement more fluent.',
        'essayVocal.high.p2': 'I would rather treat high notes as diagnostic tools. They reveal where the body is compensating, then I can move back to a lower range and rebuild the path with a lighter, steadier, more comfortable setup. Sing it quietly first, then decide whether it needs volume.',
        'essayVocal.tools.title': 'NEI, fa, and lip trill are not magic words. They are tools for controlling variables.',
        'essayVocal.tools.p1': 'The point of singing scales on NEI is to reduce part of the problem: the nasal consonant and front tongue position help the body find a thinner, more forward, less effortful high-note feeling. It is not the final sound. It is an entry point: find the position on a syllable that works, then transfer it to other vowels and words.',
        'essayVocal.tools.p2': 'fa or fo works like a different corrective tool. When the larynx sits too high, the sound gets squeezed, or the airflow is too small, a lower tongue position and more air can move the body back toward the middle. Exercises are not for making every song sound like a warmup. They are for knowing which tool exposes, isolates, and corrects which problem.',
        'essayVocal.feedback.title': 'Body feedback arrives earlier than “does it sound right?”',
        'essayVocal.feedback.p1': 'The note returns to a few sensors: place fingers on the larynx and feel whether it moves forward, up, or down on high notes; place fingers near the lips and check facial tension; attend to the tongue and inner mouth space instead of putting all attention on the sound coming out.',
        'essayVocal.feedback.p2': 'That matters to me because singing is easy to confuse with results. If I listen only for pitch and volume, I can miss the body using the wrong mechanism to finish the task. The value of vocal practice is building better internal feedback before the external sound is fully polished.',
        'essayVocal.song.title': 'In the end, vocal training should return to songs, not stop at exercises.',
        'essayVocal.song.p1': 'For thisisyz, this essay is not a private lesson note turned into a public tutorial. It is a way to put vocal work back into my music system. Singing is not a secondary layer of production. It is the most direct sound source, and the point where lyrics, melody, emotion, and recording engineering meet.',
        'essayVocal.song.p2': 'If I understand my own voice more accurately, I can write, record, arrange, and produce more accurately. Vocal training is not ultimately about proving how high I can sing. It is about making the sound a song needs appear more reliably.',
        'essayVocal.related.kicker': 'Next Notes',
