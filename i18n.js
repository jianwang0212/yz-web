...
const translations = {
    zh: {
        ...
        'sublet.pdf_html': '<p class="pdf-lead">下列文件为原始「图文喂给 AI 版」说明的副本，含图片、购买链接与更细的描述，可与本页对照使用。</p><p><a class="pdf-btn" href="apartment-sublet-handoff.pdf" download>下载房屋转租信息 PDF</a></p>',
    ...
    en: {
        ...
        'sublet.pdf_html': '<p class="pdf-lead">This is a copy of the original illustrated handoff PDF (photos, product links, and extra notes). Use it alongside this page.</p><p><a class="pdf-btn" href="apartment-sublet-handoff.pdf" download>Download sublet info PDF</a></p>',
