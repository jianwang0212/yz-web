...
const translations = {
    zh: {
        ...
        'entry.essays.title': 'Essays / 音乐花园',
        'entry.essays.desc': '按知识关联组织的公开文章、作品笔记和长期学习节点',
        'entry.essays.link': '→ 进入音乐花园',
    ...
    en: {
        ...
        'entry.essays.title': 'Essays / Music Garden',
        'entry.essays.desc': 'Public essays, work notes, and learning nodes organized by knowledge links',
        'entry.essays.link': '→ Enter the Garden',
