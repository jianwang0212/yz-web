...
const translations = {
    zh: {
        ...
        'homeMusic.snowWhite.desc': '银子演唱、作曲并制作的中文电影感流行 Demo：试听、歌词、曲谱、制作名单和写歌故事。',
        'homeMusic.snowWhite.aria': 'Snow White / 白雪公主作品链接',
        'homeMusic.mirror.desc': '银子演唱、作曲的中文 Jazz ballad：试听、歌词、创作动机、录音现场动画、乐手展示和制作名单。',
        ...
        'essayWhyMpe.map.title': '六个问题，最后汇到同一个训练方向。',
        ...
        'essayWhyBerklee.practice.p2': '我把自己放进一个更难逃避的练习结构里。每天的小练习，最后会变成听觉、手感、判断和作品速度。',
        ...
        'essayWhyBerklee.portfolio.p2': 'Berklee 是我需要的训练场；Music Production & Engineering 是我在这个训练场里最想深入的方向。',
        'essayWhyBerklee.related.kicker': 'Next Notes',
        'essayWhyBerklee.related.title': '接下来。',
        ...
        'essayVocal.lede': '如果把声音写成 (字, 音高)=f(字型, 气流, 气压)，练声就不是硬撞结果，而是调参、诊断、反馈和迁移。',
        ...
        'essayVocal.system.p1': '练声的目标，是让每一个字在每一个音高，都能舒服、持续、健康地发出来。不是先追求像谁，也不是先追求一个漂亮音色，而是先把任务拆清楚。',
        ...
        'essayVocal.vowels.p1': 'a 是咬字，里面又有原音和辅音；b 是音高。x、y、z 分别是字型、气流、气压。每一个字加每一个音高，只对应这三个参数，不能用其他的。',
        ...
        'essayVocal.diagnosis.p1': '三类根本问题：light chest 是胸声过少，音容易 flat，声音比较弱；pull chest 是扯着胸声上去，音也 flat，但听起来厚、用力，高音只能靠更大力；high larynx 是高喉头，声音薄、咽部挤，喉头在高音时前后上下乱动。',
        ...
        'essayVocal.high.p2': '另一个误解是把高音等同于大力和大声。吉他最细的弦能弹最高的音，不需要更大的力。高音更像是先把声音变轻、变小，让它自己往上走；先能小声、轻松地到那个音，再决定要不要加音量。',
        ...
        'essayVocal.feedback.p1': '声带闭合决定气流稳定，闭合强度决定能不能 hold 住音高；hold 不住就会变假音，高音里的闭合不稳定，会像喷射机一样一下有气一下没气。声带变薄，高音才更通透，但这是一件长期训练的事。',
        ...
        'financial.subtitle': '近10年财务数据可视化',
        ...
        'projects.engineering_desc': '个人网站架构、AI 辅助工作流、运营系统和音乐训练工具',
        ...
        'projects.codex_desc': '活跃 agent、token、CPU、内存和趋势数据',
        ...
        'sublet.meta': '波士顿 Fenway 附近',
        'sublet.lead': '感谢你对这间公寓的兴趣。看房、租约与物品交接欢迎直接联系我。',
    ...
    en: {
        ...
        'entry.projects.aria': 'Project links',
        ...
        'essayWhyMpe.map.kicker': 'Knowledge Map',
        'essayWhyMpe.map.title': 'Six questions converge on one direction of training.',
        'essayWhyMpe.node.center.title': 'MPE',
        ...
        'essayWhyMpe.related.kicker': 'Next Notes',
        'essayWhyMpe.related.title': 'Next.',
        'essayWhyMpe.related.whyBerklee.stage': 'Upstream',
        ...
        'essayWhyBerklee.practice.p2': 'I put myself inside a practice structure that is harder to escape. Daily small work eventually becomes hearing, touch, judgment, and speed of output.',
        ...
        'essayWhyBerklee.portfolio.p2': 'Berklee is the training ground I needed; Music Production & Engineering is the direction I most want to deepen inside it.',
        'essayWhyBerklee.related.kicker': 'Next Notes',
        'essayWhyBerklee.related.title': 'Next.',
        'essayWhyBerklee.related.mpe.stage': 'Major Choice',
        ...
        'essayVocal.lede': 'If voice can be written as (syllable, pitch)=f(vowel shape, airflow, pressure), practice becomes tuning, diagnosis, feedback, and transfer.',
        'essayVocal.map.kicker': 'Knowledge Map',
        ...
        'essayVocal.system.p1': 'Vocal practice means making every syllable at every pitch comfortable, sustainable, and healthy enough to repeat. The task is not to sound like someone else first, or to chase a beautiful tone first. The task is to define the problem clearly.',
        ...
        'essayVocal.vowels.p1': 'a is the syllable, made from vowel and consonant. b is pitch. x, y, and z are vowel shape, airflow, and pressure. Each syllable plus each pitch corresponds to these three parameters only. No other parameter gets to substitute for them.',
        ...
        'essayVocal.diagnosis.p1': 'Three root categories: light chest means too little chest voice, flatter pitch, and a weaker sound; pull chest means dragging chest upward, also flat, but thick and effortful, with high notes available only through more force; high larynx means a thin, squeezed sound, with the larynx moving forward, up, or down on high notes.',
        ...
        'essayVocal.high.p2': 'Another misconception is that high notes require more force and more volume. The thinnest guitar string makes the highest pitch without needing more force. A high note is closer to letting the sound become lighter and smaller so it can move up; first arrive quietly and comfortably, then decide whether volume is needed.',
        ...
        'essayVocal.feedback.p1': 'Vocal-fold closure determines airflow stability, and closure strength determines whether a pitch can be held. If it cannot hold, it flips into falsetto; unstable closure in high notes can feel like an engine firing inconsistently. A thinner setup can make high notes clearer, but that is long-term training.',
        ...
        'financial.subtitle': '10-Year Financial Data Visualization',
        ...
        'projects.codex_desc': 'Active agents, tokens, CPU, memory, and trends',
        ...
        'sublet.meta': 'Near Fenway, Boston',
        'sublet.lead': 'Thanks for your interest in this apartment. Reach out for showings, lease questions, and furniture pickup.',
