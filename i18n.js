...
const translations = {
    zh: {
        ...
        'essaysIndex.kicker': 'Essays',
        'essaysIndex.hero.title': '一些长期思考。',
        'essaysIndex.hero.desc': '关于市场、系统、音乐与生活。',
        ...
        'essaysIndex.cardTrading.title': '交易情绪与风险',
        'essaysIndex.cardTrading.desc': '我用了三年记录亏损、踏空、比较和平台风险，最后发现：情绪不是系统之外的噪音，它本身就是系统的一部分。',
        'essaysIndex.cardTrading.link': '阅读文章 →',
        'essaysIndex.cardAI.title': '个人 AI 三年演化',
        'essaysIndex.cardAI.desc': '从“最了解我的 GPT”到数据、Agent 与 Supervisor：三年里哪些想法变成了系统，哪些被现实修正。',
        'essaysIndex.cardAI.link': '阅读文章 →',
        'essaysIndex.cardFreedom.title': '财务自由以后',
        'essaysIndex.cardFreedom.desc': '钱解决了“不得不”，却没有回答“然后呢”。关于真实反馈、音乐、训练，以及由爱还是由恐惧驱动的一份个人答案。',
        'essaysIndex.cardFreedom.link': '阅读文章 →',
        'essaysIndex.card.title': '为什么是 MPE',
        'essaysIndex.card.desc': '从量化判断、音乐创作到制作系统：为什么我选择 MPE，而不是把音乐只当作表演或爱好。',
        'essaysIndex.card.link': '阅读文章',
        'essaysIndex.cardWhyBerklee.title': '为什么去 Berklee',
        'essaysIndex.cardWhyBerklee.desc': 'MPE 的上游问题：为什么需要一个训练场，把听、唱、弹、写、制作和协作连成长期系统。',
        'essaysIndex.cardWhyBerklee.link': '阅读文章',
        'essaysIndex.cardVocal.title': '声乐训练',
        'essaysIndex.cardVocal.desc': '把字型、气流、气压、诊断和工具箱组织成一套练声系统。',
        'essaysIndex.cardVocal.link': '阅读文章',
        'essaysIndex.cardPlans.title': '长期计划',
        'essaysIndex.cardPlans.desc': '2014 年在澳洲开始规划未来十年：从 UQ 的满绩点、奖章、论文，到 Oxford、顶级公司、经济独立和今天的创作自由。',
        'essaysIndex.cardPlans.link': '阅读文章 →',
        'essaysIndex.cardCareer.title': '工作、伙伴与长期主义',
        'essaysIndex.cardCareer.desc': '从 2022 写到 2026：创业、特殊知识、伙伴、重大决定、复利、自由，以及我没有执行原则的那些时刻。',
        'essaysIndex.cardCareer.link': '阅读文章 →',
        'essaysIndex.cardJazz.title': '为什么想学爵士乐',
        'essaysIndex.cardJazz.desc': '看到、听到一首歌以后，怎样理解它、唱出它、转调它，最后在钢琴上弹出自己的 version。',
        'essaysIndex.cardJazz.link': '阅读文章 →',
        ...
        'essaysIndex.cardHappiness.link': '阅读文章 →',
        'essaysIndex.cardIntj.title': '我的 INTJ',
        'essaysIndex.cardIntj.desc': '精神世界是主场，逻辑是对外工具。关于 Ni、Te、Fi、Se，以及我怎样把洞察变成系统。',
        'essaysIndex.cardIntj.link': '阅读文章 →',
        'essaysIndex.paths.kicker': 'Explore',
        'essaysIndex.paths.title': '继续探索',
        ...
        'essayWhyMpe.meta.description': '银子 / Zi Yin 关于为什么选择 Berklee Music Production & Engineering：从量化判断、音乐创作到制作系统。',
        'essayWhyMpe.kicker': 'Music · Production',
        'essayWhyMpe.title': '为什么是 MPE',
        ...
        'essayWhyMpe.portfolio.title': '我想把理解落回作品。',
        'essayWhyMpe.portfolio.p1': '这些判断最终应该连到具体作品：一首歌的制作笔记，一次混音复盘，一张唱片的 production analysis，一套练耳方法，或者一个课堂项目怎样变成真正的 release。',
        'essayWhyMpe.portfolio.p2': '真正重要的不是写下多少笔记，而是听觉和工程判断能不能进入下一首歌，让作品变得更清楚、更完整。',
        ...
        'essayWhyBerklee.meta.description': '银子 / Zi Yin 关于为什么去 Berklee：把音乐从兴趣、直觉和作品欲望，训练成一个可持续的系统。',
        'essayWhyBerklee.kicker': 'Music · Training',
        ...
        'essayWhyBerklee.practice.p1': '我给自己留下过很多练习清单：scales、chord progressions、modes、voicing、sight singing、transposition、improvisation。它们看起来琐碎，但共同指向同一个问题：怎样让音乐能力不是靠偶尔爆发，而是靠日复一日的复利。',
        ...
        'essayVocal.meta.description': '银子 / Zi Yin 关于 Kevin vocal class 的练习笔记：发声 = 咬字 + 音高，把字型、气流、气压、诊断和工具箱组织成一个练声系统。',
        'essayVocal.kicker': 'Voice · Practice',
        ...
        'essayVocal.song.p1': '声乐不是一套孤立于歌曲之外的技术。唱歌是最直接的声源，也是歌词、旋律、情绪与录音工程之间的交界面。',
        ...
        // Projects
        'projects.meta.title': '项目 - Zi Yin（银子）',
        'projects.meta.description': 'Zi Yin（银子）的项目：研究系统、音乐工具、健康记录与阶段档案。',
        'projects.title': '项目。',
        'projects.kicker': '项目索引',
        'projects.intro': '一些正在使用、持续迭代的系统与工具。',
        'projects.categories.aria': '项目分类',
        'projects.systems.title': '系统与研究',
        'projects.systems.desc': '研究、自动化与日常运营。',
        'projects.music.title': '音乐工具',
        'projects.music.desc': '听、弹、识别与制作。',
        'projects.health.title': '健康',
        'projects.health.desc': '身体数据、训练与复盘。',
        'projects.archive.title': 'Archive',
        'projects.archive.desc': '阶段记录与曾经公开的页面。',
        'projects.codex_monthly_title': 'Codex 最近一个月项目小结',
        'projects.codex_monthly_desc': 'Slack agent、Zapp、音乐 demo、健身报告、远程工作站和课程归档的图文复盘',
        ...
        'projects.codex_desc': '活跃 agent、token、CPU、内存和趋势数据的公开摘要',
        'projects.socialpulse_title': 'SocialPulse 发布检查台',
        'projects.socialpulse_desc': '五个平台的发布状态、库存和最近标题',
        'projects.leadsheet_title': '歌曲 Leadsheet 数据库',
        'projects.leadsheet_desc': '华语流行曲 lead sheet 合集：和弦、旋律与歌词对照，持续整理',
        ...
        'projects.tag.library': '资料库',
        'projects.tag.project_recap': '项目复盘',
        'projects.back': '← 返回项目',
    ...
    en: {
        ...
        'essaysIndex.kicker': 'Essays',
        'essaysIndex.hero.title': 'Long-term notes.',
        'essaysIndex.hero.desc': 'On markets, systems, music, and life.',
        ...
        'essaysIndex.node.snow.title': 'Snow White',
        'essaysIndex.node.system.title': 'System',
        'essaysIndex.cardTrading.title': 'Trading Emotions & Risk',
        ...
        'essaysIndex.cardTrading.link': 'Read essay →',
        'essaysIndex.cardAI.title': 'Three Years of Personal AI',
        'essaysIndex.cardAI.desc': 'From “the GPT that knows me best” to data, agents, and supervisors: what became a system, and what reality forced me to revise.',
        'essaysIndex.cardAI.link': 'Read essay →',
        'essaysIndex.cardFreedom.title': 'After Financial Freedom',
        ...
        'essaysIndex.cardFreedom.link': 'Read essay →',
        'essaysIndex.card.title': 'Why MPE',
        ...
        'essaysIndex.cardWhyBerklee.title': 'Why Berklee',
        ...
        'essaysIndex.cardVocal.title': 'Vocal Training',
        'essaysIndex.cardVocal.desc': 'A vocal practice system built around syllables, airflow, pressure, diagnosis, and tools.',
        'essaysIndex.cardVocal.link': 'Read Essay',
        'essaysIndex.cardPlans.title': 'Long-term Plans',
        ...
        'essaysIndex.cardPlans.link': 'Read essay →',
        'essaysIndex.cardCareer.title': 'Work, Partners & Long-termism',
        ...
        'essaysIndex.cardCareer.link': 'Read essay →',
        'essaysIndex.cardJazz.title': 'Why Jazz',
        ...
        'essaysIndex.cardJazz.link': 'Read essay →',
        'essaysIndex.cardHappiness.title': 'Happiness, Peace & Choice',
        ...
        'essaysIndex.cardHappiness.link': 'Read essay →',
        'essaysIndex.cardIntj.title': 'My INTJ',
        'essaysIndex.cardIntj.desc': 'The inner world as home, logic as an outward tool: Ni, Te, Fi, Se, and how I turn insight into systems.',
        'essaysIndex.cardIntj.link': 'Read essay →',
        'essaysIndex.paths.kicker': 'Explore',
        'essaysIndex.paths.title': 'Keep exploring',
        ...
        'essayWhyMpe.meta.description': 'Why Berklee Music Production & Engineering matters to Zi Yin: from quantitative judgment to music-making systems.',
        'essayWhyMpe.kicker': 'Music · Production',
        'essayWhyMpe.title': 'Why MPE',
        ...
        'essayWhyMpe.portfolio.title': 'I want the understanding to return to the work.',
        'essayWhyMpe.portfolio.p1': 'These ideas should eventually connect to concrete work: production notes for a song, a mixing postmortem, an album production analysis, an ear-training method, or a class project that becomes an actual release.',
        'essayWhyMpe.portfolio.p2': 'The point is not how many notes I write. It is whether better listening and engineering judgment enter the next song and make the work clearer and more complete.',
        'essayWhyMpe.related.kicker': 'Next Notes',
        ...
        'essayWhyBerklee.meta.description': 'Why Berklee matters to Zi Yin: turning musical taste, instinct, and the desire to create into a sustainable training system.',
        'essayWhyBerklee.kicker': 'Music · Training',
        ...
        'essayWhyBerklee.practice.p1': 'I have left myself many practice lists: scales, chord progressions, modes, voicings, sight singing, transposition, improvisation. They look small and procedural, but they all point to one question: how can musical ability compound instead of depending on occasional bursts of motivation?',
        ...
        'essayVocal.meta.description': 'Zi Yin’s notes from Kevin vocal class: voice as syllable plus pitch, organized through vowel shape, airflow, pressure, diagnosis, and practice tools.',
        'essayVocal.kicker': 'Voice · Practice',
        ...
        'essayVocal.song.p1': 'Vocal technique does not sit apart from the song. Singing is the most direct sound source, where lyrics, melody, emotion, and recording engineering meet.',
        ...
        // Projects
        'projects.meta.title': 'Projects - Zi Yin',
        'projects.meta.description': 'Zi Yin’s projects: research systems, music tools, health records, and past work.',
        'projects.title': 'Projects.',
        'projects.kicker': 'Project Index',
        'projects.intro': 'Systems and tools I use and keep improving.',
        'projects.categories.aria': 'Project categories',
        'projects.systems.title': 'Systems & Research',
        'projects.systems.desc': 'Research, automation, and daily operations.',
        'projects.music.title': 'Music Tools',
        'projects.music.desc': 'Listening, playing, recognition, and production.',
        'projects.health.title': 'Health',
        'projects.health.desc': 'Body data, training, and review.',
        'projects.archive.title': 'Archive',
        'projects.archive.desc': 'Past phases and pages once made public.',
        'projects.codex_monthly_title': 'A Month of Projects with Codex',
        'projects.codex_monthly_desc': 'A visual recap of the Slack agent, Zapp, music demos, workout reports, remote workstation, and course archive',
        ...
        'projects.codex_desc': 'A public summary of active agents, tokens, CPU, memory, and trends',
        ...
        'projects.leadsheet_title': 'Song Leadsheet Library',
        'projects.leadsheet_desc': 'An expanding collection of Mandarin pop lead sheets with chords, melody, and lyrics',
        ...
        'projects.tag.project_recap': 'Project Recap',
